...
const lintStagedConfiguration = (answers) => `module.exports = {
...
export const createLinterConfiguration = async (answers) => {
    ...
    const response = await execCommandOnProject(answers)(`echo "${lintStagedConfiguration(answers)}" > .lintstagedrc.js`);
